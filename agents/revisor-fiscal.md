...
3. **Cuadra entre modelos**. Es donde aparecen la mayoría de los errores:
...
4. **Verifica cada cifra normativa** (tipos, límites, umbrales, mínimos) contra
   `config/parametros-fiscales.md` y, si puedes, contra la fuente oficial. Marca las que
